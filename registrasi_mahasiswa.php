...
<html lang="en">
  ...
  <body>
    ...
    <form action="registrasi1.php" method="POST" class="was-validated">
  <div class="container">
...
<div class="form-floating mb-3">
  <input type="text" name="alamat" class="form-control" id="floatingAlamat">
...
<?php 
	if (isset($_POST['tombol'])) {
		...
		$sql = "INSERT INTO user (nama, alamat, tanggalLahir, email, username, password) VALUES ('".$nama."'
		, '".$alamat."', '".$tanggalLahir."', '".$email."', '".$username."', '".$password."')";
